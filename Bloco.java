...
public class Bloco {
	...
	private String conteudo;					//conteudo do bloco ( como String para facilitar ).
	...
	//Construtor privado para só ser possivel criar um bloco a partir da mineracao.
	...
	public static Bloco minerarBloco(String conteudo, String hashAnterior) throws IOException {
		TextFile tf = new TextFile("Blockchain", "C:\\Files Blockchain");
		String hash = "                                                                 ";
		int auxContador = 0;
		long auxNano = 0;
		...
		tf.addLinha(bloco.toString() + " Quantidade de Hashs Gerados = " + auxContador);
		tf.SalvarFile();
		return bloco;
	}
	...
	public void setConteudoRefazendoHash(String conteudoAdulterado) throws IOException {
		TextFile tf = new TextFile("Blockchain", "C:\\Files Blockchain");
		this.conteudo = conteudoAdulterado;
		String hash = "                          ";
		long auxNano = 0;
		...
		this.hash = hash;
		tf.addLinha(this.toString() + " Contador ==> " + contador);
		tf.SalvarFile();
	}
